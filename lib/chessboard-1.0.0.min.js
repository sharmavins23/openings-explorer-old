        ...
        (window.Chessboard = function (e, f) {
            ...
            function m(e, r, n) {
                if (
                    ...
                    return "console" === f.showErrors &&
                        ...
                        ? (console.log(t),
                          void (2 <= arguments.length && console.log(n)))
                        : "alert" === f.showErrors
                        ? (n && (t += "\n\n" + JSON.stringify(n)),
                          void window.alert(t))
            ...
            function k(e) {
                var r = _(c),
                    n = _(e);
                ce(r) !== ce(n) &&
                    (ne(f.onChange) && f.onChange(r, n), (c = e));
            }
            function E(e, r) {
                for (var n in w)
            ...
            function C() {
                r.find("." + H.square).removeClass(
                    H.highlight1 + " " + H.highlight2
                );
            }
            function B() {
                C();
